...
## Project Structure
    ...
    ├── testapiautocatalog_108571  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_108571`
...
2. Clone this repo and `cd testapiautocatalog_108571`
